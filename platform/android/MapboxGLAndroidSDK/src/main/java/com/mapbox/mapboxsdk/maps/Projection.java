...
public class Projection {
   ...
   */
  public void getMetersPerPixelAtLatitude(@FloatRange(from = -90, to = 90) final double latitude, final ResultListener<Double> listener) {
    mapState.queueRenderEvent(new State.NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
   ...
   */
  public void fromScreenLocation(final PointF point, final ResultListener<LatLng> listener) {
    mapState.queueRenderEvent(new State.NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
   ...
   */
  public void getVisibleRegion(final ResultListener<VisibleRegion> listener) {
    mapState.queueRenderEvent(new State.NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
   ...
   */
  public void toScreenLocation(final LatLng location, final ResultListener<PointF> listener) {
    mapState.queueRenderEvent(new State.NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
