 ...
 * </p>
 */
class AnnotationManager extends State {
  ...
  AnnotationManager(NativeMapView view, GLSurfaceView surfaceView, MapView mapView, MarkerViewManager markerViewManager) {
    super(view, surfaceView);
  ...
  void addMarker(@NonNull final BaseMarkerOptions markerOptions, @NonNull final MapboxMap mapboxMap, final ResultListener<Marker> onMarkerResult) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
  ...
  void addMarkers(@NonNull final List<? extends BaseMarkerOptions> markerOptionsList,
                  @NonNull final MapboxMap mapboxMap, final ResultListener<List<Marker>> onMarkersAddedResult) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
  ...
  void addMarker(@NonNull final BaseMarkerViewOptions markerOptions, @NonNull final MapboxMap mapboxMap,
                 final ResultListener<MarkerView> resultListener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
        ...
        // FIXME: 08/02/2017 replace below with ResultListener
        //        @Nullable final MarkerViewManager.OnMarkerViewAddedListener onMarkerViewAddedListener,
        ...
        if (resultListener != null) {
          resultListener.onResult(marker);
        }
      }
    });
  }
  ...
  void addMarkerViews(@NonNull final List<? extends BaseMarkerViewOptions> markerViewOptions,
                      @NonNull final MapboxMap mapboxMap, final ResultListener<List<MarkerView>> resultListener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
        ...
        if (resultListener != null) {
          resultListener.onResult(markers);
        }
      }
    });
  }
  ...
  void getMarkersInRect(@NonNull final RectF rectangle, final ResultListener<List<Marker>> resultListener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
        ...
        if (resultListener != null) {
          resultListener.onResult(new ArrayList<>(annotations));
        }
      }
    });
  }

  void getMarkerViewsInRect(@NonNull final RectF rectangle, final ResultListener<List<MarkerView>> resultListener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
        float pixelRatio = nativeMapView.getPixelRatio();
  ...
  void addPolygon(@NonNull final PolygonOptions polygonOptions, @NonNull final MapboxMap mapboxMap, final ResultListener<Polygon> listener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
  ...
  void addPolygons(@NonNull final List<PolygonOptions> polygonOptionsList, @NonNull final MapboxMap mapboxMap, final ResultListener<List<Polygon>> listResultListener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
        ...
        queueUiEvent(new Runnable() {
          ...
          public void run() {
            if (listResultListener != null) {
              listResultListener.onResult(polygons);
            }
          }
        });
      }
  ...
  void addPolyline(@NonNull final PolylineOptions polylineOptions, @NonNull final MapboxMap mapboxMap, final ResultListener<Polyline> listener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
  ...
  void addPolylines(@NonNull final List<PolylineOptions> polylineOptionsList, @NonNull final MapboxMap mapboxMap, final ResultListener<List<Polyline>> listener) {
    queueRenderEvent(new NativeMapRunnable() {
      @Override
      public void execute(@NonNull NativeMapView nativeMapView) {
  ...
  boolean onTap(PointF tapPoint, float screenDensity) {
    ...
    getMarkersInRect(tapRect, new ResultListener<List<Marker>>() {
      @Override
